...
//    func createLine(xOffset: CGFloat, yOffset: CGFloat, lWidth: CGFloat = lineWidth, lLength: CGFloat, colour: SKColor = .white, zPos: CGFloat = -53, multiLine: Bool = true, lineParent: SKScene) {
...
//        lineParent.addChild(line1)
//        print("Self = \(lineParent)")   //otherwise self = line instead of SKScene!!!
//        print("cLsize.width = \(size.width)")
//        
//        if multiLine {
